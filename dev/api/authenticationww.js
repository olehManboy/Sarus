            ...
            $.ajax({
                ...
                error: function ( XMLHttpRequest )
                {
                    ...
                    if ( status == 0 )
                        ...
                        dialogWindow(XMLHttpRequest.responseJSON.Errors[0].Details, "error", null, "IDM API Result", () => {}, () => {}, { funcName: funcName, parameters: parameters, data: XMLHttpRequest, type: type });
...
function dialogWindow(msg, type = null, dialog = null, title = null, callback = () => {}, closed = () => {}, enableDetails = null, button = {Ok: "Ok", Cancel: "Cancel"}, delay = 100)
{
    ...
    {
        var userName = '', userRef = '', userCompany = '';
    ...
    title = ( title !== null ) ? title : "IDM Favorites";
