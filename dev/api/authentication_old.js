            ...
            $.ajax({
                ...
                error: function ( XMLHttpRequest )
                {
                    ...
                    if ( status == 0 )
                        ...
                        dialogWindow("The request returned error " + status + ". ( " + errorMsg + " )", "error", null, "IDM API Result", () => {}, () => {}, { funcName: funcName, parameters: parameters, data: XMLHttpRequest, type: type });
