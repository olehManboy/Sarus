...
$( document ).ready(function ()
{
    ...
    $(".fixpage").toggleClass('fullscreen', true);
            ...
            async function initActiveJqxgrid()
            {
                ...
                $("#activeJqxgrid").jqxGrid(
                {
                    ...
                    rendertoolbar: function (toolbar)
                    {
                        ...
                        $("#fullWidth2").jqxButton({ imgSrc: "resources/css/icons/fullscreen1.png", imgPosition: "left", width: 25, height: 24, textPosition: "right" });
                ...
                $(document).bind('mousemove', function ( event )
                {
                    if (isDragStart == true) {
                        ...
                        var item = $("#jqxTree").jstree('hitTest', x, y);
