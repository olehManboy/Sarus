...
$(document).ready(function () {
  ...
  $(window).resize(function () {
    var panel_height = ($('.fixpage').css("height").slice(0,-2) - 210)+"px";
                $('#jqxgrid').css("height", (panel_height.slice(0,-2)-107))
                $('.slick-viewport').css('height', (panel_height.slice(0,-2)-107));
                $('.slick-pane-top').css('top', '0px').css('height', (panel_height.slice(0,-2)-107));
            setTimeout(() => {
