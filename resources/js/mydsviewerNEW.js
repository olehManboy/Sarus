...
$(document).ready(function () {
    ...
    function CreateAddlHeaderRow() {
        ...
        $preHeaderPanel.append(container);
        ...
        // Define buttons
        $("#btnCopySeriesToFavorite").jqxButton({ imgSrc: "resources/css/icons/starAdd16.png", imgPosition: "left", width: 125, height: 24, textPosition: "right" });
        ...
        $("#btnAutosize").jqxButton({ imgSrc: "resources/css/icons/autosize.png", imgPosition: "center", width: 27 });
    ...
    var grid;
    var columns = [
        {id: "sel", name: "#", field: "num", behavior: "select", cssClass: "cell-title", width: 50, cannotTriggerInsert: true, resizable: false, selectable: false, excludeFromColumnPicker: true},
        {id: "favorite", name: "<img height='18' width='18' src='resources/css/icons/StarGrey.ico'>", field: "Favorite", filterable: false, cssClass: "cell-title", minwidth: 32, width: 32, resizable: false, selectable: false},
        {id: "symbol", name: "Symbol", field: "Symbol", width: 100, minWidth: 100, cssClass: "cell-title", sortable: true},
        {id: "description", name: "Description", field: "Name", sortable: true, width: 300, cssClass: "cell-title"},
        {id: "frequency", defaultSortAsc: false, name: "Frequency", field: "Frequency", width: 80, resizable: false, formatter: Slick.Formatters.PercentCompleteBar, sortable: true, cssClass: "cell-title"},
        ...
        {id: "values", name: "# Prices", field: "Values", minWidth: 80, width: 80, sortable: true, cssClass: "cell-title"},
        {id: "currency", name: "Currency", field: "Currency", minWidth: 75, width: 75, sortable: true, cssClass: "cell-title"},
        {id: "decimals", name: "Decimals", field: "Decimals", minWidth: 65, width: 65, sortable: true, cssClass: "cell-title"},
        {id: "unit", name: "Unit", field: "Unit", minWidth: 60, width: 60, sortable: true, cssClass: "cell-title"},
        {id: "conversions", name: "Conversions", field: "Conversions", minWidth: 50, width: 50, sortable: true, cssClass: "cell-title"},
        {id: "additional", name: "Additional", field: "Additional", minWidth: 150, width: 150, sortable: true, cssClass: "cell-title"},
    ...
    if (CategoryDS)
        columns.splice(3, 0, { id: "category", name: 'Category', groupable: false, field: 'Datacategory', cellsalign: 'left', align: 'center', width: 80 })
