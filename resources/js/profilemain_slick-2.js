        ...
        function activeGrid() {
            ...
            async function initActiveJqxgrid() {
                ...
                $(function () {
                    ...
                    grid1.onMouseEnter.subscribe(function (e) {
                        e.preventDefault();
                        var cell = grid1.getCellFromEvent(e);
                        var indexes = grid1.getSelectedRows()
                        indexes.push(cell.row);
                ...
                // create context menu
                // tn311
                var tn_jqx_menu = $("#jqxGridMenu").jqxMenu({
                    width: 200,
                    height: 94,
                    autoOpenPopup: false,
                    mode: 'popup'
        ...
        async function showBackupsList() {
            ...
            if (!backups_loaded) {
                ...
                $(function () {
                    ...
                    $('#backupsJqxgrid').css("height", (panel_height.slice(0, -2) - 32))
                    $('.slick-viewport').css('height', "calc(100% - 60px)");
                    $('.slick-pane-top').css('height', "calc(100% - 40px)");
        ...
        function editBackup() {
            ...
            if (getselectedrowindexes.length == 0)
                ...
                if (newBackupName == null || newBackupName == '') {
                    ...
                    console.log('grid4.getData()', grid4.getData());
